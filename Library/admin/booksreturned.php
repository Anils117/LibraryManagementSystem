...
<div class="mngissue container">
	<div class="mngissue-content">
		<div class="ss-name">
			<h2 class="ss-header">Issued Books</h2>
		</div>
				...
				<table class="table table-striped table-bordered table-hover">
					<thead>
	                    <tr id="mngbooks-thead">
	                        ...
	                        <th id="returned-date">Returned Date</th>
                	...
                	<tbody id="mngbooks-trow">
                		<tr>
	                       <?php
						$sql = "select * from Library.issuerequests where Status='returned'";
